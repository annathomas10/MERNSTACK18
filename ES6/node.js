...
// non-blocking, single threaded using event loop - this is the power
// of javascript. Because you get all this concurrency without the headache
// of contention etc
// LinkedIn reduced servers from 30 to 3 (90% reduction)
// Paypal also got a lot from the power of nodejs on backend server
// scalable network applications
// servers, APIs, file system interactions and all other thing that we can think 
// of by development framework
